        ...
        if (mysqli_query($koneksi, $query_anggota)) {
            if (!empty($_POST['password'])) {
                ...
                if (mysqli_query($koneksi, $query_user)) {
                    ...
                    pesan('warning', "Data Anggota Berhasil diubah, tetapi password gagal karena: " . mysqli_error($koneksi));
                }
            } else {
                ...
                if (mysqli_query($koneksi, $query_user)) {
                    ...
                    pesan('warning', "Data Anggota Berhasil diubah, tetapi username gagal karena: " . mysqli_error($koneksi));
                }
            }
        } else {
