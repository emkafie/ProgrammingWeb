    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="index.php?page=anggota" class="btn btn-primary"><i class="fa fa-users" aria-hidden="true">Kelola</i></a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="index.php?page=jabatan" class="btn btn-primary"><i class="fa fa-puzzle-piece" aria-hidden="true">Kelola</i></a>
            </div>
        </div>
    </div>
</div>
