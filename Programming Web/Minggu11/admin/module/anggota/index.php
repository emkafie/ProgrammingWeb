                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=anggota/edit&id=<?php echo
                                                                            $row['user_id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o"
                        ...
                        <form action="fungsi/tambah.php?anggota=tambah" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="level" name
                                        aria-label="Default select example">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
                                    data-bs-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i> Close</button>
